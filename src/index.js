...
function generatePoem(event) {
  ...
  let context =
    "You are an Irish poem expert and love to write short poems. Your mission is to generate a short Irish Poem in basic HTML and separate each line with <br />. Make sure to follow the user instructions. Please do not generating anything mentioning HTML, only generate the poem. The poem doe not need to be in quotes at all. Please always include a title inside <strong> element.";
